...
import { PoweredByArtha } from '@/components/shared/PoweredByArtha'
...
export function InvestorShell({ children, showPoweredBy, subdomain }: InvestorShellProps) {
    ...
    return (
        <div className="min-h-screen bg-surface-dark flex flex-col">
            ...
            {/* Artha platform badge — fixed, bottom-right, above mobile nav */}
            <PoweredByArtha showPoweredBy={showPoweredBy} subdomain={subdomain} />
        </div>
    )
}
